  ...
  return (
    <div className="w-full max-w-7xl mx-auto p-4 md:p-6 space-y-6 bg-[#090d16] text-slate-100 min-h-screen">
      ...
      <div className="flex items-center gap-2 text-sm text-slate-400">
        ...
        <span className="text-slate-100">Warehouse</span>
      </div>

      {/* Top Navigation Bar */}
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0f172a]/60 border border-slate-800/80 rounded-2xl p-4">
        <div className="flex items-center gap-4 flex-1 min-w-0">
          ...
          <div className="flex-1 max-w-xl relative">
            ...
            <input
              ...
              className="w-full bg-[#101929] border border-slate-800 rounded-xl pl-9 pr-4 py-2 text-sm text-slate-200 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-cyan-500/40 transition-all"
            />
          </div>
        </div>
        <div className="flex items-center gap-3 flex-shrink-0">
          <button
            ...
            className="p-2 rounded-xl hover:bg-slate-800/50 text-slate-400 hover:text-slate-100 transition-all"
            title="Toggle dark mode"
          >
            {isDark ? <Sun className="w-5 h-5" /> : <Moon className="w-5 h-5" />}
          </button>
          <button className="p-2 rounded-xl hover:bg-slate-800/50 text-slate-400 hover:text-slate-100 transition-all relative">
            <Bell className="w-5 h-5" />
            <span className="absolute top-1 right-1 w-2 h-2 bg-rose-500 rounded-full"></span>
          </button>
          <div className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-emerald-950/30 border border-emerald-500/30 text-emerald-400 text-xs font-medium">
            <CheckCircle className="w-4 h-4" />
            <span>Operations scope</span>
          </div>
          <button className="p-2 rounded-xl hover:bg-slate-800/50 text-slate-400 hover:text-slate-100 transition-all">
